(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 6152))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 22536))
 (global $~lib/memory/__heap_base i32 (i32.const 22536))
 (memory $0 1)
 ...
 (func $assembly/index/clamp<f64> (param $0 f64) (param $1 f64) (param $2 f64) (result f64)
  local.get $0
  local.get $1
  f64.max
  local.get $2
